...
menu: Theming
description: Learn how to customize the components of components-extra.
---
...
all the components. You can check out this custom theme [below](/theming/customization#default-theme).
...
of Material-UI. You can find the documentation about it on [Material-ui's docs](https://material-ui.com/styles/advanced/#accessing-the-theme-in-a-component).
...
All the **components-extra** are exported as [styled-components](https://styled-components.com), so you can extend them, and
