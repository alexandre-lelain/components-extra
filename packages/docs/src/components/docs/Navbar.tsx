...
export const AmericaFlag: JSX.Element = () => (
  <svg
...
export const LanguageExtended: JSX.Element = () => {
  const [selectedLanguage, setLang] = React.useState('English')
  return (
    <LanguageExtendedStyled selectedLanguage={selectedLanguage}>
      <Navbar.LanguageItem label="english" onClick={(): void => setLang('English')}>
        English
      </Navbar.LanguageItem>
      <Navbar.LanguageItem label="french" onClick={(): void => setLang('Français')}>
        Français
      </Navbar.LanguageItem>
