...
You can totally override the default `theme`. By default, the components use the following [custom theme](https://components-extra.netlify.com/?path=/story/theme--default).
...
import ThemeView from './utils/ThemeView'
